...
CREATE TABLE `project_columns` (
  ...
  `column_name` varchar(16) DEFAULT NULL,
...
--
-- Dumping data for table `project_columns`
--

LOCK TABLES `project_columns` WRITE;
/*!40000 ALTER TABLE `project_columns` DISABLE KEYS */;
INSERT INTO `project_columns` VALUES (1,NULL,NULL,NULL);
/*!40000 ALTER TABLE `project_columns` ENABLE KEYS */;
UNLOCK TABLES;
