...
CREATE TABLE `project_resources` (
  ...
  CONSTRAINT `ProjectID_fk_2` FOREIGN KEY (`project_id`) REFERENCES `project` (`project_id`),
  CONSTRAINT `ResourceID` FOREIGN KEY (`resource_id`) REFERENCES `resource` (`resource_id`)
...
INSERT INTO `project_resources` VALUES (1,1,1,'2021-10-04');
